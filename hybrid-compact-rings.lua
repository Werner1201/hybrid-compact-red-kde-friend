...
Werner Added global_x and top and down_global_y to controll where you want the Lua generated Circles are positioned in 3 variables to user "friendlyness"
Configured some color changes and Transparency and configured for it to Work with KDE
]]
...
text_settings = {
    ...
    { text = 'CPU', show = true, text_radius = 112, x = 190, y = 655, s_angle = 1, e_angle = 50, l_position = 0 },
    { text = 'GPU', show = true, text_radius = 86, x = 190, y = 655, s_angle = 1, e_angle = 50, l_position = 0 },
    { text = 'BAT', show = true, text_radius = 112, x = 190, y = 655, s_angle = 121, e_angle = 155, l_position = 0 },
    
    -- ram
    { text = 'RAM', show = true, text_radius = 112, x = 190, y = 655, s_angle = 241, e_angle = 275, l_position = 0 },
    { text = 'SWP', show = true, text_radius = 86, x = 190, y = 655, s_angle = 241, e_angle = 275, l_position = 0 },

    -- disk storage
    { text = '/', show = true, text_radius = 71, x = 190, y = 655, s_angle = 10, e_angle = 40, l_position = 0 },
    { text = '/opt', show = true, text_radius = 71, x = 190, y = 655, s_angle = 100, e_angle = 160, l_position = 0 },
    { text = '/usr', show = true, text_radius = 71, x = 190, y = 655, s_angle = 190, e_angle = 250, l_position = 0 },
    { text = '/home', show = true, text_radius = 71, x = 190, y = 655, s_angle = 278, e_angle = 345, l_position = 0 },

    -- clock
    { text = 'HH', show = true, x = 166, y = 659 },
    { text = 'MM', show = true, x = 184, y = 659 },
    { text = 'SS', show = true, x = 202, y = 659 },
    
    -- cpu core
    { text = 'C01', show = true, text_radius = 112, x = global_x, y = top_global_y, s_angle = 1, e_angle = 50, l_position = 0 },
    { text = 'C02', show = true, text_radius = 112, x = global_x, y = top_global_y, s_angle = 121, e_angle = 170, l_position = 0 },
    { text = 'C03', show = true, text_radius = 112, x = global_x, y = top_global_y, s_angle = 241, e_angle = 290, l_position = 0 },
    
    { text = 'C04', show = true, text_radius = 86, x = global_x, y = top_global_y, s_angle = 1, e_angle = 50, l_position = 0 },
    { text = 'C05', show = true, text_radius = 86, x = global_x, y = top_global_y, s_angle = 121, e_angle = 170, l_position = 0 },
    { text = 'C06', show = true, text_radius = 86, x = global_x, y = top_global_y, s_angle = 241, e_angle = 290, l_position = 0 },

    -- cpu threads
    { text = '1', show = true, text_radius = 71, x = global_x, y = top_global_y, s_angle = 10, e_angle = 40, l_position = 0 },
    { text = '2', show = true, text_radius = 71, x = global_x, y = top_global_y, s_angle = 100, e_angle = 130, l_position = 0 },
    { text = '3', show = true, text_radius = 71, x = global_x, y = top_global_y, s_angle = 190, e_angle = 220, l_position = 0 },
    { text = '4', show = true, text_radius = 71, x = global_x, y = top_global_y, s_angle = 280, e_angle = 310, l_position = 0 },

    { text = '5', show = true, text_radius = 55, x = global_x, y = top_global_y, s_angle = 5, e_angle = 40, l_position = 0 },
    { text = '6', show = true, text_radius = 55, x = global_x, y = top_global_y, s_angle = 95, e_angle = 130, l_position = 0 },
    { text = '7', show = true, text_radius = 55, x = global_x, y = top_global_y, s_angle = 185, e_angle = 220, l_position = 0 },
    { text = '8', show = true, text_radius = 55, x = global_x, y = top_global_y, s_angle = 275, e_angle = 310, l_position = 0 },

    { text = '9', show = true, text_radius = 40, x = global_x, y = top_global_y, s_angle = 0, e_angle = 40, l_position = 0 },
    { text = '10', show = true, text_radius = 40, x = global_x, y = top_global_y, s_angle = 90, e_angle = 130, l_position = 0 },
    { text = '11', show = true, text_radius = 40, x = global_x, y = top_global_y, s_angle = 180, e_angle = 220, l_position = 0 },
    { text = '12', show = true, text_radius = 40, x = global_x, y = top_global_y, s_angle = 270, e_angle = 310, l_position = 0 },
}
...
function draw_elements(line_sketches_toggle)
    ...
    local function draw_logo(cr)
        local w, h = 0, 0
        local imagefile = home_dir .. "/.config/conky/hybrid-compact/images/distro-4a.png"
        local image = cairo_image_surface_create_from_png (imagefile)
    
        w = cairo_image_surface_get_width (image)
        h = cairo_image_surface_get_height (image)
    
        cairo_translate (cr, 290.0, 32.0)
        -- cairo_rotate (cr, 45* math.pi/180)
        cairo_scale  (cr, 50.0/w, 50.0/h)
        -- cairo_translate (cr, -0.5*w, -0.5*h)
    
        cairo_set_source_surface (cr, image, 20, 220)
        cairo_paint (cr)
